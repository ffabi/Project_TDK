...
class DataGenerator(keras.utils.Sequence):
    ...
    def __init__(self, args, set_type, shape, batch_size = 4, shuffle = False, keep_ratio = 1):
        """Initialization"""
...
if __name__ == '__main__':
    ...
    with sess.as_default():
        datagen = DataGenerator(args = None, set_type = "overfit", batch_size = 4, shuffle = False, shape = (576, 1024))
        print(datagen)
